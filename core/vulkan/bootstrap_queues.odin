...
enumerate_queues :: proc(gpu: vk.PhysicalDevice) -> (queues: []GPU_Queue, alloc_err: mem.Allocator_Error){
	...
	queue_families := make([]vk.QueueFamilyProperties, queue_family_count) or_return
...
@(require_results)
get_general_purpose_queue :: proc(queues: ^[]GPU_Queue) -> (general_purpose_queue: GPU_Queue, found: bool){
    for &queue in queues{
...
@(require_results)
get_separate_compute_queue :: proc(queues: ^[]GPU_Queue) -> (compute_queue: GPU_Queue, found: bool){
    for &queue in queues{
...
@(require_results)
get_separate_transfer_queue :: proc(queues: ^[]GPU_Queue) -> (compute_queue: GPU_Queue, found: bool){
    for &queue in queues{
...
@(require_results)
get_separate_sparse_binding_queue :: proc(queues: ^[]GPU_Queue) -> (compute_queue: GPU_Queue, found: bool){
    for &queue in queues{
...
get_queue :: proc(device: vk.Device, gpu_queue: GPU_Queue) -> (queue: vk.Queue){
